...
- www.joes-hardware.com : 버의 위치로서 웹 클라이언트가 리소스가 **어디에 호스팅** 되어있는지 알려줍니다.
- seasonal/index-fall.html : 리소스의 경로로서 서버에 존재하는 리소스 중 **요청 받은 클라이언트가 무엇**인지 알려줍니다.
...
### 질의 문자열
데이터베이스 같은 서비스 요청받을 리소스 형식의 범위를 좁히기 위해 질문이나 질의를 받을 수 있습니다.
